...
const RightAside = () => {
  return (
    <div>
      <div className="mb-7">
        <h1 className="font-semibold text-xl text-[#403F3F]">Login With</h1>

        {/* Google */}
        <button className="btn w-full bg-white text-black border-[#e5e5e5] my-5 flex items-center justify-center gap-1 xl:gap-2">
          <svg
      ...
      <div>
        <h1 className="text-xl font-semibold text-[#403F3F] mb-5">
          Find Us On
        </h1>
